...
# for some reason defaulted_RF returns: Unknown or uninitialised column: 'loan_status'. 

defaulted_RF <- randomForest(defaulted ~. , data=subset(dataset, select=c(-id_2, -loan_status)) , subset =  small_trainRows, importance=TRUE, do.trace = TRUE, ntree=ntree)
 }
defaulted_RF
...
defaulted_int_rate <- dataset[small_trainRows,]$defaulted
