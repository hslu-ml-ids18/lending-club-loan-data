...
# MAPE LM TEST
MAPE(predict(fit.lm.reg, test.data.reg), test.data.reg$int_rate)

# MAPE glmStepAIC TEST
MAPE(predict(fit.glmStepAIC.reg, test.data.reg), test.data.reg$int_rate)

# MAPE bridge TEST
MAPE(predict(fit.bridge.reg, test.data.reg), test.data.reg$int_rate)

# MAPE Randdom Forest TEST
MAPE(predict(fit.RF.reg, test.data.reg), test.data.reg$int_rate)
