...
dataset$sub_grade<- mapvalues(dataset$sub_grade, levels_sub_grade, seq(from = 1, to = 35, by = 1))
...
dataset$emp_length_new <- ordered(dataset$emp_length, levels = c("n/a", "< 1 year", "1 year", "2 years", "3 years","4 years", "5 years","6 years", "7 years", "8 years", "9 years", "10+ years"))
levels(dataset$emp_length_new)
dataset$emp_length <- mapvalues(dataset$emp_length, levels_emp_length, seq(from = -1, to = 10, by = 1))
