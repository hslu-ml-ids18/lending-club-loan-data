...
```{r message=FALSE, warning=FALSE}
  ...
  # change NAs to 0 in factor columns
...
In our case missing data for int_rate was simply removed, other variables that did have missing data we treated as follow:
